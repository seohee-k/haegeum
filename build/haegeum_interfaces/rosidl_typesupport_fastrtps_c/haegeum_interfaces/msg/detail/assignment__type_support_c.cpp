...
#include "haegeum_interfaces/msg/detail/assignment__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // assigned_robot, mission_type, target_id
#include "rosidl_runtime_c/string_functions.h"  // assigned_robot, mission_type, target_id
...
using _Assignment__ros_msg_type = haegeum_interfaces__msg__Assignment;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_haegeum_interfaces
bool cdr_serialize_haegeum_interfaces__msg__Assignment(
  const haegeum_interfaces__msg__Assignment * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_haegeum_interfaces
bool cdr_deserialize_haegeum_interfaces__msg__Assignment(
  eprosima::fastcdr::Cdr & cdr,
  haegeum_interfaces__msg__Assignment * ros_message)
{
  // Field name: target_id
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_haegeum_interfaces
size_t get_serialized_size_haegeum_interfaces__msg__Assignment(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_haegeum_interfaces
size_t max_serialized_size_haegeum_interfaces__msg__Assignment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = haegeum_interfaces__msg__Assignment;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_haegeum_interfaces
bool cdr_serialize_key_haegeum_interfaces__msg__Assignment(
  const haegeum_interfaces__msg__Assignment * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: target_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_haegeum_interfaces
size_t get_serialized_size_key_haegeum_interfaces__msg__Assignment(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Assignment__ros_msg_type * ros_message = static_cast<const _Assignment__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_haegeum_interfaces
size_t max_serialized_size_key_haegeum_interfaces__msg__Assignment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const haegeum_interfaces__msg__Assignment * ros_message = static_cast<const haegeum_interfaces__msg__Assignment *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_haegeum_interfaces__msg__Assignment(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  haegeum_interfaces__msg__Assignment * ros_message = static_cast<haegeum_interfaces__msg__Assignment *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_haegeum_interfaces__msg__Assignment(cdr, ros_message);
}

static uint32_t _Assignment__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_haegeum_interfaces__msg__Assignment(
...
static size_t _Assignment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_haegeum_interfaces__msg__Assignment(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, haegeum_interfaces, msg, Assignment)() {
