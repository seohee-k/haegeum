...
#include "haegeum_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = haegeum_interfaces::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const haegeum_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<haegeum_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &haegeum_interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
