...
#include "haegeum_interfaces/msg/detail/target__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const haegeum_interfaces::msg::Target & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  haegeum_interfaces::msg::Target & ros_message)
{
  // Member: target_id
  cdr >> ros_message.target_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = haegeum_interfaces::msg::Target;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const haegeum_interfaces::msg::Target *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<haegeum_interfaces::msg::Target *>(
    untyped_ros_message);
...
get_message_type_support_handle<haegeum_interfaces::msg::Target>()
{
  return &haegeum_interfaces::msg::typesupport_fastrtps_cpp::_Target__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, haegeum_interfaces, msg, Target)() {
  return &haegeum_interfaces::msg::typesupport_fastrtps_cpp::_Target__handle;
}
