...
bool haegeum_interfaces__msg__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("haegeum_interfaces.msg._event.Event", full_classname_dest, 35) == 0);
  }
  haegeum_interfaces__msg__Event * ros_message = _ros_message;
  {  // stamp
...
PyObject * haegeum_interfaces__msg__event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("haegeum_interfaces.msg._event");
