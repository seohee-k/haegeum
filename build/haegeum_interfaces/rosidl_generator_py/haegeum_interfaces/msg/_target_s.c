...
bool haegeum_interfaces__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("haegeum_interfaces.msg._target.Target", full_classname_dest, 37) == 0);
  }
  haegeum_interfaces__msg__Target * ros_message = _ros_message;
  {  // target_id
  ...
  {  // detected_by
    PyObject * field = PyObject_GetAttrString(_pymsg, "detected_by");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->detected_by, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
PyObject * haegeum_interfaces__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("haegeum_interfaces.msg._target");
  ...
  {  // detected_by
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->detected_by.data,
      strlen(ros_message->detected_by.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "detected_by", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
